...
This site is written using the [Astro](https://astro.build) framework and static site generator. It is written in Typescript and TailwindCSS. It supports Markdown and MDX based pages and blog posts.
